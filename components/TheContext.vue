<template>
  <aside :class="['the-context context-x',contextClass]" @click="toggleContext">
...
export default {
  ...
  computed: {
    ...
    styleY() {
      ...
      return {
        transform: `translateY(calc(-50% + 1em + ${Math.ceil(img.h / 2 * scale)}px))`,
      }
    },
...
.the-context {
  ...
  .slides {
    margin: 0 -.5em; // offset inner margin
    cursor: default; // TODO
  }
